...
app.post('/post-course', upload.single('brochureImage'),(req,res)=>{
    ...
    if(req.file) {
        ...
        collection_instance.insertOne({"title":req.body.title,"prerequisite":req.body.prerequisite,"description":req.body.description,"fee":req.body.fee,"keywords":req.body.}, (err, data) => {
            if(err){
