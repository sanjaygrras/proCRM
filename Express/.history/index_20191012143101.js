...
app.post('/subject-in-course', bodyParser.json(), (req,res)=> {
    ...
    collection.updateOne({_id:ObjectId(req.body.courseId)},{$push: {Topics:{topicTitle: req.body.title, topicDuration: req.body.duration, topicDescription: req.body.description }}}, (notOk,ok) => {
        if(!notOk && ok) {
