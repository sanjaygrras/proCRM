...
app.post('/folloup-student', (req,res) => {
    let collection = connection.db('procrm').collection('student_lead');
    connection.updateOne({_id:ObjectId(req.body.followupId)},{$push:{$followup:{followup_result:req.body.fResult, next_date:req.body.nDate, followupTitle:req.body.followupTitle}}})
})
